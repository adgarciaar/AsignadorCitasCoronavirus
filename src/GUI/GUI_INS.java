...
public class GUI_INS extends javax.swing.JFrame {
    ...
    private InterfaceINS servidorINS;

    /** Creates new form GUI_INS
     * @param servidorINS */
    public GUI_INS(InterfaceINS servidorINS) {
        initComponents();
        this.servidorINS = servidorINS;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_INS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void addRowToJTablePacientes(String documento, String nombre, int puntaje){        
